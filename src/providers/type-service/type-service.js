...
/*
  ...
  and Angular DI.
*/
var TypeServiceProvider = /** @class */ (function () {
    function TypeServiceProvider(_http) {
        this._http = _http;
        this.url = GLOBAL.url;
    }
    TypeServiceProvider.prototype.getTypeServices = function (token) {
    ...
    TypeServiceProvider = __decorate([
        Injectable(),
        __metadata("design:paramtypes", [HttpClient])
    ], TypeServiceProvider);
    return TypeServiceProvider;
}());
export { TypeServiceProvider };
